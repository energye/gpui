// Package types provides FFI type definitions used by the gpui/ffi package.
//
// This package mirrors the API of github.com/go-webgpu/goffi/types to enable
// a drop-in replacement of the import path. All exported types, constants,
// and variables have identical signatures.
package types
...
var (
	...
	PointerTypeDescriptor = &TypeDescriptor{Size: unsafe.Sizeof(uintptr(0)), Alignment: unsafe.Alignof(uintptr(0)), Kind: PointerType}
)
