...
func (b *mockBackend) SetClip(_ *render.Path, _ FillRule)                    {}
func (b *mockBackend) ClearClip()                                            {}
func (b *mockBackend) FillPath(_ *render.Path, _ Brush, _ FillRule)          {}
func (b *mockBackend) StrokePath(_ *render.Path, _ Brush, _ Stroke)          {}
