...
func TestBackendFillRect(t *testing.T) {
	...
	brush := recording.NewSolidBrush(render.Red)
...
func TestBackendFillPath(t *testing.T) {
	...
	brush := recording.NewSolidBrush(render.Blue)
...
func TestBackendStrokePath(t *testing.T) {
	...
	brush := recording.NewSolidBrush(render.Green)
...
func TestBackendDashedStroke(t *testing.T) {
	...
	brush := recording.NewSolidBrush(render.Black)
	stroke := recording.Stroke{
		Width:       3.0,
