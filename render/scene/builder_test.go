...
func TestSceneBuilderLayer(t *testing.T) {
	...
	result := builder.Layer(BlendMultiply, 0.8, nil, func(b *SceneBuilder) {
		...
		b.Fill(NewRectShape(0, 0, 100, 100), SolidBrush(render.Red))
	})
...
func TestSceneBuilderLayerWithClip(t *testing.T) {
	...
	builder.Layer(BlendNormal, 1.0, clip, func(b *SceneBuilder) {
		b.Fill(NewRectShape(0, 0, 100, 100), SolidBrush(render.Blue))
	})
...
func TestSceneBuilderGroup(t *testing.T) {
	...
	result := builder.Group(func(b *SceneBuilder) {
		...
		b.Fill(NewRectShape(0, 0, 100, 100), SolidBrush(render.Red))
		b.Fill(NewCircleShape(50, 50, 25), SolidBrush(render.Blue))
	})
...
func TestSceneBuilderBuild(t *testing.T) {
	...
	builder.Fill(NewRectShape(0, 0, 100, 100), SolidBrush(render.Red))
...
func TestSceneBuilderFillRect(t *testing.T) {
	...
	result := builder.FillRect(10, 20, 100, 50, SolidBrush(render.Red))
...
func TestSceneBuilderStrokeRect(t *testing.T) {
	...
	result := builder.StrokeRect(0, 0, 100, 100, SolidBrush(render.Black), 2.0)
...
func TestSceneBuilderFillCircle(t *testing.T) {
	...
	result := builder.FillCircle(50, 50, 25, SolidBrush(render.Blue))
...
func TestSceneBuilderStrokeCircle(t *testing.T) {
	...
	result := builder.StrokeCircle(50, 50, 25, SolidBrush(render.Black), 2.0)
...
func TestSceneBuilderDrawLine(t *testing.T) {
	...
	result := builder.DrawLine(0, 0, 100, 100, SolidBrush(render.Green), 1.0)
...
func TestSceneBuilderFillPath(t *testing.T) {
	...
	result := builder.FillPath(path, SolidBrush(render.Red))
...
func TestSceneBuilderStrokePath(t *testing.T) {
	...
	result := builder.StrokePath(path, SolidBrush(render.Black), 2.0)
...
func TestSceneBuilderFluentChaining(t *testing.T) {
	...
	scene := NewSceneBuilder().
		Fill(NewRectShape(0, 0, 800, 600), SolidBrush(render.White)).
		Translate(100, 100).
		Layer(BlendMultiply, 0.8, nil, func(b *SceneBuilder) {
			b.Fill(NewCircleShape(0, 0, 50), SolidBrush(render.Red)).
				Stroke(NewCircleShape(0, 0, 50), SolidBrush(render.Black), 2)
		}).
		Build()
	...
	scene := NewSceneBuilder().
		Layer(BlendNormal, 1.0, nil, func(b *SceneBuilder) {
			...
			b.Layer(BlendMultiply, 0.5, nil, func(b2 *SceneBuilder) {
				b2.Fill(NewCircleShape(50, 50, 25), SolidBrush(render.Blue))
			})
		}).
		Build()
...
func TestSceneBuilderComplexScene(t *testing.T) {
	...
	scene := NewSceneBuilder().
		// Background
		FillRect(0, 0, 800, 600, SolidBrush(render.White)).
		// Header
		Group(func(b *SceneBuilder) {
			b.FillRect(0, 0, 800, 60, SolidBrush(render.Blue))
		}).
		...
		Clip(NewRectShape(0, 0, 700, 400), func(b *SceneBuilder) {
			...
			for i := 0; i < 5; i++ {
				x := float32(i * 140)
				b.FillRect(x, 0, 120, 100, SolidBrush(render.Red))
			}
		}).
		...
		Translate(0, 540).
		Layer(BlendMultiply, 0.8, nil, func(b *SceneBuilder) {
			b.FillRect(0, 0, 800, 60, SolidBrush(render.Green))
		}).
		Build()
...
func BenchmarkSceneBuilderChain(b *testing.B) {
	...
	for i := 0; i < b.N; i++ {
		_ = NewSceneBuilder().
			FillRect(0, 0, 800, 600, SolidBrush(render.White)).
			Translate(100, 100).
			FillCircle(0, 0, 50, SolidBrush(render.Red)).
			Build()
	}
}
...
func BenchmarkSceneBuilderWithLayer(b *testing.B) {
	...
	for i := 0; i < b.N; i++ {
		_ = NewSceneBuilder().
			Layer(BlendMultiply, 0.8, nil, func(b *SceneBuilder) {
				b.FillCircle(50, 50, 25, SolidBrush(render.Red))
			}).
			Build()
	}
}
	...
	for i := 0; i < b.N; i++ {
		_ = NewSceneBuilder().
			...
			Layer(BlendNormal, 1.0, NewRectShape(50, 50, 700, 500), func(b *SceneBuilder) {
				b.Translate(100, 100)
				for j := 0; j < 10; j++ {
					b.FillCircle(float32(j*50), 0, 20, SolidBrush(render.Red))
				}
			}).
			Build()
	}
