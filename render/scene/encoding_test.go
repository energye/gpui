...
func TestReset(t *testing.T) {
	...
	path.Rectangle(0, 0, 100, 100)
	enc.EncodePath(path)
	enc.EncodeFill(SolidBrush(render.Red), FillNonZero)
...
func TestHash(t *testing.T) {
	...
	enc1.EncodeFill(SolidBrush(render.Red), FillNonZero)

	enc2 := NewEncoding()
	path2 := render.NewPath()
	path2.Rectangle(0, 0, 100, 100)
	enc2.EncodePath(path2)
	enc2.EncodeFill(SolidBrush(render.Red), FillNonZero)
	...
	enc3 := NewEncoding()
	path3 := render.NewPath()
	path3.Rectangle(0, 0, 200, 200) // Different size
	enc3.EncodePath(path3)
	enc3.EncodeFill(SolidBrush(render.Red), FillNonZero)
...
func TestHashStability(t *testing.T) {
	...
	enc.EncodePath(path)
	enc.EncodeFill(SolidBrush(render.Blue), FillEvenOdd)
...
func TestAppend(t *testing.T) {
	...
	path2.Rectangle(100, 100, 50, 50)
	enc2.EncodePath(path2)
	enc2.EncodeFill(SolidBrush(render.Blue), FillNonZero)
...
func TestAffineFromMatrix(t *testing.T) {
	m := render.Matrix{A: 1, B: 2, C: 3, D: 4, E: 5, F: 6}
