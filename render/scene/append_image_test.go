...
func TestAppendWithImages_MixedTags(t *testing.T) {
	...
	encA.EncodeFill(SolidBrush(render.Red), FillNonZero)
	encA.EncodeImage(0, IdentityAffine())
	...
	encB.EncodeFill(SolidBrush(render.Blue), FillNonZero)
	encB.EncodeImage(0, IdentityAffine())
...
func TestSceneAppend_BoundsMerge(t *testing.T) {
	sceneA := NewScene()
	sceneA.Fill(FillNonZero, IdentityAffine(), SolidBrush(render.Red), NewRectShape(0, 0, 50, 50))

	sceneB := NewScene()
	sceneB.Fill(FillNonZero, IdentityAffine(), SolidBrush(render.Blue), NewRectShape(100, 100, 100, 100))
...
func TestSceneAppend_VersionIncremented(t *testing.T) {
	...
	sceneB := NewScene()
	sceneB.Fill(FillNonZero, IdentityAffine(), SolidBrush(render.Blue), NewRectShape(50, 50, 100, 100))
