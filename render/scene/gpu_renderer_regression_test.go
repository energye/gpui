...
func TestGPUSceneRenderer_FillAppliesCTM(t *testing.T) {
	...
	scene := NewScene()
	scene.Fill(FillNonZero, IdentityAffine(), SolidBrush(render.RGBA{R: 1, G: 0, B: 0, A: 1}),
...
func TestGPUSceneRenderer_StrokeAppliesCTM(t *testing.T) {
	...
	scene.Stroke(style, IdentityAffine(), SolidBrush(render.RGBA{R: 0, G: 1, B: 0, A: 1}),
...
func TestGPUSceneRenderer_TransformPreservesParentCTM(t *testing.T) {
	...
	scene := NewScene()
	scene.Fill(FillNonZero, TranslateAffine(30, 30), SolidBrush(render.RGBA{R: 0, G: 0, B: 1, A: 1}),
		NewRectShape(0, 0, 10, 10))
...
func TestGPUSceneRenderer_FillRoundRect(t *testing.T) {
	...
	scene.Fill(FillNonZero, IdentityAffine(), SolidBrush(render.RGBA{R: 1, G: 1, B: 0, A: 1}),
...
func TestGPUSceneRenderer_MultipleTransformsNoStackCorruption(t *testing.T) {
	...
	scene.Fill(FillNonZero, TranslateAffine(10, 10), SolidBrush(render.RGBA{R: 1, A: 1}),
		NewRectShape(0, 0, 5, 5))
	scene.Fill(FillNonZero, TranslateAffine(10, 30), SolidBrush(render.RGBA{G: 1, A: 1}),
		NewRectShape(0, 0, 5, 5))
	scene.Fill(FillNonZero, TranslateAffine(10, 50), SolidBrush(render.RGBA{B: 1, A: 1}),
		NewRectShape(0, 0, 5, 5))
...
func TestGPUSceneRenderer_ClipWithMultipleChildTransforms(t *testing.T) {
	...
	s.Fill(FillNonZero, TranslateAffine(20, 70),
		SolidBrush(render.RGBA{B: 1, A: 1}),
