...
func TestSceneFillNilShape(t *testing.T) {
	...
	scene.Fill(FillNonZero, IdentityAffine(), SolidBrush(render.Red), nil)
...
func TestSceneStrokeDefaultStyle(t *testing.T) {
	...
	scene.Stroke(nil, IdentityAffine(), SolidBrush(render.Black), line)
...
func TestScenePushPopClip(t *testing.T) {
	...
	rect := NewRectShape(0, 0, 100, 100)
	scene.Fill(FillNonZero, IdentityAffine(), SolidBrush(render.Blue), rect)
...
func TestSceneEncoding(t *testing.T) {
	...
	scene.Fill(FillEvenOdd, IdentityAffine(), SolidBrush(render.Blue), circle)
...
func TestSceneVersion(t *testing.T) {
	...
	scene.Fill(FillNonZero, IdentityAffine(), SolidBrush(render.Red), NewRectShape(0, 0, 10, 10))
	v1 := scene.Version()
	if v1 <= v0 {
		t.Error("version should increment after Fill")
	}
...
func TestSceneBoundsTracking(t *testing.T) {
	...
	// Draw first shape
	scene.Fill(FillNonZero, IdentityAffine(), SolidBrush(render.Red), NewRectShape(0, 0, 50, 50))
	bounds1 := scene.Bounds()

	// Draw second shape (should expand bounds)
	scene.Fill(FillNonZero, IdentityAffine(), SolidBrush(render.Blue), NewRectShape(100, 100, 50, 50))
...
func TestScenePool(t *testing.T) {
	...
	// Add content
	s1.Fill(FillNonZero, IdentityAffine(), SolidBrush(render.Red), NewRectShape(0, 0, 100, 100))
...
func BenchmarkSceneComplex(b *testing.B) {
	...
	for i := 0; i < b.N; i++ {
		...
		// Background
		scene.Fill(FillNonZero, IdentityAffine(), SolidBrush(render.White),
		...
		for j := 0; j < 10; j++ {
			scene.Fill(FillNonZero, IdentityAffine(), SolidBrush(render.Red),
...
func BenchmarkScenePoolGetPut(b *testing.B) {
	...
	for i := 0; i < b.N; i++ {
		s := pool.Get()
		s.Fill(FillNonZero, IdentityAffine(), SolidBrush(render.Red),
...
func TestEncodingBoundsWithTransform(t *testing.T) {
	...
	scene.Fill(FillNonZero, transform, SolidBrush(render.Red), NewRectShape(0, 0, 100, 100))
...
func TestEncodingBoundsClipDoesNotExpand(t *testing.T) {
	...
	scene.Fill(FillNonZero, IdentityAffine(), SolidBrush(render.Blue), NewRectShape(10, 10, 30, 30))
