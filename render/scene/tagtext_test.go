...
func TestEncodeText_MultipleRuns(t *testing.T) {
	enc := NewEncoding()
	brush := SolidBrush(render.RGBA{R: 1, G: 1, B: 1, A: 1})
	enc.brushes = append(enc.brushes, brush)
...
func TestScene_DrawText_NilFace(t *testing.T) {
	s := NewScene()
	err := s.DrawText("hello", nil, 0, 0, SolidBrush(render.Black))
	if err == nil {
...
func TestScene_DrawGlyphs_Empty(t *testing.T) {
	s := NewScene()
	err := s.DrawGlyphs("", nil, nil, 0, 0, SolidBrush(render.Black))
	if err != nil {
...
func TestScene_DrawGlyphs_NilFace(t *testing.T) {
	...
	err := s.DrawGlyphs("A", glyphs, nil, 0, 0, SolidBrush(render.Black))
	if err == nil {
...
func TestScene_FontRegistry_Append(t *testing.T) {
	...
	s1.Fill(FillNonZero, IdentityAffine(), SolidBrush(render.Black), rect)
	s2.Fill(FillNonZero, IdentityAffine(), SolidBrush(render.Black), rect)
...
func TestEncoding_AppendWithImages_TagText_BrushOffset(t *testing.T) {
	enc1 := NewEncoding()
	enc1.brushes = append(enc1.brushes, SolidBrush(render.RGBA{R: 1}), SolidBrush(render.RGBA{G: 1}))

	enc2 := NewEncoding()
	enc2.brushes = append(enc2.brushes, SolidBrush(render.RGBA{B: 1}))
...
func TestEncoding_AppendWithTranslation_TagText_OriginOffset(t *testing.T) {
	...
	enc2.brushes = append(enc2.brushes, SolidBrush(render.White))
	run := GlyphRunData{
...
func TestEncoding_AppendWithTranslation_TagText_Mixed(t *testing.T) {
	...
	enc2.brushes = append(enc2.brushes, SolidBrush(render.Red), SolidBrush(render.Blue))
...
func BenchmarkEncodeText_10Glyphs(b *testing.B) {
	enc := NewEncoding()
	enc.brushes = append(enc.brushes, SolidBrush(render.White))
