...
func (f *AdaptiveFiller) SparseFiller() render.CoverageFiller {
	return &f.sparse
}

// ComputeFiller returns the TileCompute (16x16 tiles) filler component.
func (f *AdaptiveFiller) ComputeFiller() render.CoverageFiller {
	return &f.compute
}
...
func (f *AdaptiveFiller) FillCoverage(
	path *render.Path, width, height int, fillRule render.FillRule,
