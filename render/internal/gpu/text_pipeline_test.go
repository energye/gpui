...
func TestTextPipelineRenderText(t *testing.T) {
	...
	t.Run("not initialized error", func(t *testing.T) {
		...
		err := uninitPipeline.RenderText(nil, []TextQuad{{X0: 0}}, 0, render.White, render.Identity())
	...
	t.Run("empty quads error", func(t *testing.T) {
		err := pipeline.RenderText(nil, nil, 0, render.White, render.Identity())
	...
	t.Run("negative atlas index error", func(t *testing.T) {
		...
		err := pipeline.RenderText(nil, quads, -1, render.White, render.Identity())
	...
	t.Run("too many quads error", func(t *testing.T) {
		...
		err := pipeline.RenderText(nil, quads, 0, render.White, render.Identity())
		if err == nil {
	...
	t.Run("valid render", func(t *testing.T) {
		...
		err := pipeline.RenderText(nil, quads, 0, render.Red, render.Identity())
		if err != nil {
...
func TestTextUniforms(t *testing.T) {
	t.Run("identity transform", func(t *testing.T) {
		uniforms := prepareUniforms(render.White, render.Identity(), 4.0)
	...
	t.Run("translated transform", func(t *testing.T) {
		uniforms := prepareUniforms(render.Red, render.Translate(100, 50), 4.0)
	...
	t.Run("premultiplied color", func(t *testing.T) {
		semiTransparent := render.RGBA{R: 1, G: 0.5, B: 0, A: 0.5}
		uniforms := prepareUniforms(semiTransparent, render.Identity(), 4.0)
...
func TestTextBatch(t *testing.T) {
	batch := TextBatch{
		...
		Color:     render.Blue,
		Transform: render.Translate(50, 50),
	}
...
func TestRenderTextBatch(t *testing.T) {
	...
	batches := []TextBatch{
		...
		},
		{
			...
			Color:     render.Blue,
			Transform: render.Translate(10, 0),
		},
	}
...
func TestMakeTextUniform(t *testing.T) {
	buf := makeTextUniform(render.White, render.Identity(), 4.0, 256.0)
...
func BenchmarkPrepareUniforms(b *testing.B) {
	color := render.RGBA{R: 1, G: 0.5, B: 0.25, A: 0.8}
	transform := render.Translate(100, 50).Multiply(render.Scale(2, 2))
