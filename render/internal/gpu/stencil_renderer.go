...
func (sr *StencilRenderer) RecordPath(rp *wgpu.RenderPassEncoder, bufs *stencilCoverBuffers, fillRule render.FillRule, clipBG *wgpu.BindGroup, depthClipped ...bool) {
