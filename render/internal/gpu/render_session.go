...
func (s *GPURenderSession) resolveActiveView(target render.GPURenderTarget) *wgpu.TextureView {
...
func (s *GPURenderSession) effectiveDimensions(target render.GPURenderTarget, activeView *wgpu.TextureView) (uint32, uint32) {
	if activeView != nil {
...
func (s *GPURenderSession) RenderFrameGrouped(target render.GPURenderTarget, groups []ScissorGroup, baseLayer *GPUTextureDrawCommand, sharedEncoder *wgpu.CommandEncoder) error { //nolint:gocognit,gocyclo,cyclop,funlen,maintidx // sequential resource setup + group dispatch
...
func (s *GPURenderSession) copySubmitAndReadback(
	encoder *wgpu.CommandEncoder, w, h uint32, target render.GPURenderTarget,
) error {
