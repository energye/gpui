...
func TestBuildConvexVerticesDegeneratePolygon(t *testing.T) {
	...
	commands := []ConvexDrawCommand{
		{
			Points: []render.Point{render.Pt(0, 0), render.Pt(100, 100)},
			Color:  [4]float32{1, 0, 0, 1},
		},
	}
	data := BuildConvexVertices(commands)
	...
	commands = []ConvexDrawCommand{
		{
			Points: []render.Point{render.Pt(50, 50)},
			Color:  [4]float32{1, 0, 0, 1},
		},
	}
	data = BuildConvexVertices(commands)
...
func TestBuildConvexVerticesMultipleCommands(t *testing.T) {
	commands := []ConvexDrawCommand{
		{
			Points: []render.Point{
				render.Pt(0, 0), render.Pt(100, 0), render.Pt(50, 100),
			},
			Color: [4]float32{1, 0, 0, 1},
		},
		{
			Points: []render.Point{
				render.Pt(200, 200), render.Pt(300, 200),
				render.Pt(300, 300), render.Pt(200, 300),
			},
			Color: [4]float32{0, 1, 0, 1},
		},
	}
...
func TestConvexDrawCommandFields(t *testing.T) {
	cmd := ConvexDrawCommand{
		Points: []render.Point{
			render.Pt(0, 0), render.Pt(100, 0), render.Pt(100, 100),
		},
...
func TestConvexVertexCount(t *testing.T) {
	tests := []struct {
		...
		},
		{
			name: "triangle",
			commands: []ConvexDrawCommand{
				{Points: []render.Point{render.Pt(0, 0), render.Pt(1, 0), render.Pt(0, 1)}},
			},
			want: 27, // 3 * 9
		},
		{
			name: "square",
			commands: []ConvexDrawCommand{
				{Points: []render.Point{render.Pt(0, 0), render.Pt(1, 0), render.Pt(1, 1), render.Pt(0, 1)}},
			},
			want: 36, // 4 * 9
		},
		{
		...
		},
		{
			...
			commands: []ConvexDrawCommand{
				{Points: []render.Point{render.Pt(0, 0), render.Pt(1, 0)}},
			},
			want: 0,
		},
		{
			...
			commands: []ConvexDrawCommand{
				{Points: []render.Point{render.Pt(0, 0), render.Pt(1, 0), render.Pt(0, 1)}},                  // 27
				{Points: []render.Point{render.Pt(0, 0)}},                                                    // 0
				{Points: []render.Point{render.Pt(0, 0), render.Pt(1, 0), render.Pt(1, 1), render.Pt(0, 1)}}, // 36
			},
			want: 63,
		},
	}
...
func TestRenderSessionConvexOnly(t *testing.T) {
	...
	commands := []ConvexDrawCommand{
		{
			Points: []render.Point{
				render.Pt(50, 50), render.Pt(150, 50), render.Pt(100, 150),
			},
			Color: [4]float32{1, 0, 0, 1},
		},
	}
...
func TestRenderSessionMixedWithConvex(t *testing.T) {
	...
	convexCmds := []ConvexDrawCommand{
		{
			Points: []render.Point{render.Pt(200, 50), render.Pt(280, 50), render.Pt(240, 130)},
			Color:  [4]float32{0, 1, 0, 1},
		},
	}
...
func BenchmarkBuildConvexVerticesTriangle(b *testing.B) {
	commands := []ConvexDrawCommand{
		{
			Points: []render.Point{render.Pt(0, 0), render.Pt(100, 0), render.Pt(50, 100)},
			Color:  [4]float32{1, 0, 0, 1},
		},
	}
	b.ResetTimer()
