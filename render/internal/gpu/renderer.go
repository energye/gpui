...
func (r *GPUSceneRenderer) RenderToPixmap(target *render.Pixmap, s *scene.Scene) error {
...
func (r *GPUSceneRenderer) RenderToPixmapWithContext(ctx context.Context, target *render.Pixmap, s *scene.Scene) error {
	if target == nil {
		return ErrNilTarget
	}
