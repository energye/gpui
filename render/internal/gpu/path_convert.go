...
func convertPathToPathDef(path *render.Path, paint *render.Paint) tilecompute.PathDef {
	...
	if paint != nil && paint.FillRule == render.FillRuleEvenOdd {
...
func extractColorU8(paint *render.Paint) [4]uint8 {
	if paint == nil {
