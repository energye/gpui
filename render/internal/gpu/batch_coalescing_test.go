...
func TestGlyphMaskBatch_CanMerge_DifferentTransform(t *testing.T) {
	...
	b := GlyphMaskBatch{
		Transform:      render.Matrix{A: 2, B: 0, C: 0, D: 0, E: 2, F: 0},
		Color:          [4]float32{1, 1, 1, 1},
		IsLCD:          false,
		AtlasPageIndex: 0,
	}
...
func TestTextBatch_CanMerge_DifferentColor(t *testing.T) {
	a := TextBatch{
		Transform:  render.Identity(),
		Color:      render.RGBA{R: 1, G: 0, B: 0, A: 1},
		AtlasIndex: 0,
		PxRange:    4.0,
		AtlasSize:  1024,
	}
	b := TextBatch{
		Transform:  render.Identity(),
		Color:      render.RGBA{R: 0, G: 1, B: 0, A: 1},
		AtlasIndex: 0,
		PxRange:    4.0,
		AtlasSize:  1024,
	}
...
func TestTextBatch_CanMerge_DifferentTransform(t *testing.T) {
	...
	b := TextBatch{
		Transform:  render.Matrix{A: 1, B: 0, C: 100, D: 0, E: 1, F: 50},
		Color:      render.RGBA{R: 1, G: 1, B: 1, A: 1},
		AtlasIndex: 0,
		PxRange:    4.0,
		AtlasSize:  1024,
...
func TestQueueGlyphMask_MixedSequence(t *testing.T) {
	...
	batches := []GlyphMaskBatch{
		{Transform: render.Identity(), Color: white, AtlasPageIndex: 0, Quads: []GlyphMaskQuad{{X0: 0}}},
		{Transform: render.Identity(), Color: white, AtlasPageIndex: 0, Quads: []GlyphMaskQuad{{X0: 10}}},
		{Transform: render.Identity(), Color: red, AtlasPageIndex: 0, Quads: []GlyphMaskQuad{{X0: 20}}},
		{Transform: render.Identity(), Color: white, AtlasPageIndex: 0, Quads: []GlyphMaskQuad{{X0: 30}}},
		{Transform: render.Identity(), Color: white, AtlasPageIndex: 0, Quads: []GlyphMaskQuad{{X0: 40}}},
	}
...
func TestQueueText_MixedSequence(t *testing.T) {
	...
	batches := []TextBatch{
		{Transform: render.Identity(), Color: white, AtlasIndex: 0, PxRange: 4, AtlasSize: 1024, Quads: []TextQuad{{X0: 0}}},
		{Transform: render.Identity(), Color: white, AtlasIndex: 0, PxRange: 4, AtlasSize: 1024, Quads: []TextQuad{{X0: 10}}},
		{Transform: render.Identity(), Color: red, AtlasIndex: 0, PxRange: 4, AtlasSize: 1024, Quads: []TextQuad{{X0: 20}}},
		{Transform: render.Identity(), Color: white, AtlasIndex: 0, PxRange: 4, AtlasSize: 1024, Quads: []TextQuad{{X0: 30}}},
		{Transform: render.Identity(), Color: white, AtlasIndex: 0, PxRange: 4, AtlasSize: 1024, Quads: []TextQuad{{X0: 40}}},
	}
...
func makeCoalesceTestTarget() render.GPURenderTarget {
