...
func makeTrianglePath() *render.Path {
	p := render.NewPath()
	p.MoveTo(0, 0)
	p.LineTo(100, 0)
	p.LineTo(50, 100)
...
func makeSquarePath() *render.Path {
	p := render.NewPath()
	p.MoveTo(10, 10)
	p.LineTo(60, 10)
	p.LineTo(60, 60)
...
func makeDonutPath() *render.Path {
	p := render.NewPath()
	p.Circle(100, 100, 80)
	p.Circle(100, 100, 30)
	return p
...
func TestFanTessellateEmpty(t *testing.T) {
	...
	count = ft.TessellatePath(render.NewPath())
	if count != 0 {
...
func makeStrokeExpandedSineWavePath() *render.Path {
