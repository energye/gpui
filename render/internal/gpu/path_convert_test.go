...
func TestConvertPathToPathDef_ColorExtraction(t *testing.T) {
	tests := []struct {
		...
		{"black", render.Black, [4]uint8{0, 0, 0, 255}},
		{"white", render.White, [4]uint8{255, 255, 255, 255}},
		{"red", render.Red, [4]uint8{255, 0, 0, 255}},
		{"green", render.Green, [4]uint8{0, 255, 0, 255}},
		{"blue", render.Blue, [4]uint8{0, 0, 255, 255}},
		{"half-transparent", render.RGBA2(1, 0, 0, 0.5), [4]uint8{255, 0, 0, 128}},
		{"transparent", render.Transparent, [4]uint8{0, 0, 0, 0}},
	}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			paint := render.NewPaint()
			paint.SetBrush(render.Solid(tt.color))
...
func TestConvertPathToPathDef_FillRule(t *testing.T) {
	...
	// NonZero (default)
	paintNZ := render.NewPaint()
	paintNZ.FillRule = render.FillRuleNonZero
	...
	// EvenOdd
	paintEO := render.NewPaint()
	paintEO.FillRule = render.FillRuleEvenOdd
