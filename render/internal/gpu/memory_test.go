...
func TestTextureUploadDownload(t *testing.T) {
	...
	wrongPixmap := render.NewPixmap(20, 20)
...
func TestTextureAtlasErrors(t *testing.T) {
	...
	wrongPixmap := render.NewPixmap(64, 64)
