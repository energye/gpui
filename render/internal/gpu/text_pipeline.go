		...
		Entries: []types.BindGroupLayoutEntry{
			{
				...
				Buffer:     &types.BufferBindingLayout{Type: types.BufferBindingTypeUniform, MinBindingSize: textUniformSize},
			},
			{
				Binding:    1,
...
func textVertexLayout() []types.VertexBufferLayout {
...
func prepareUniforms(color render.RGBA, transform render.Matrix, pxRange float32) TextUniforms {
	premul := color.Premultiply()
