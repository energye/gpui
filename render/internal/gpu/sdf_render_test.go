...
func TestDetectedShapeToRenderShapeCircle(t *testing.T) {
	...
	paint := &render.Paint{Brush: render.SolidBrush{Color: render.RGBA{R: 1, G: 0, B: 0, A: 1}}}
...
func TestDetectedShapeToRenderShapeEllipse(t *testing.T) {
	shape := render.DetectedShape{
		Kind:    render.ShapeEllipse,
		CenterX: 50, CenterY: 50,
		RadiusX: 40, RadiusY: 20,
	}
	paint := &render.Paint{Brush: render.SolidBrush{Color: render.RGBA{R: 0, G: 1, B: 0, A: 0.5}}}
...
func TestDetectedShapeToRenderShapeRRect(t *testing.T) {
	...
	paint := &render.Paint{Brush: render.SolidBrush{Color: render.RGBA{R: 0, G: 0, B: 1, A: 1}}}
...
func TestDetectedShapeToRenderShapeRect(t *testing.T) {
	...
	paint := &render.Paint{Brush: render.SolidBrush{Color: render.RGBA{R: 1, G: 1, B: 1, A: 1}}}
