...
func TestSnapPathToPixelGrid(t *testing.T) {
	...
	var coords []float64
	snapped.Iterate(func(verb render.PathVerb, c []float64) {
...
func TestSnapPathToPixelGrid_AlreadyAligned(t *testing.T) {
	...
	path.Iterate(func(_ render.PathVerb, c []float64) {
		original = append(original, c...)
	})
	snapped.Iterate(func(_ render.PathVerb, c []float64) {
...
func makeTestTargetForAA(w, h int) render.GPURenderTarget {
