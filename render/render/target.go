...
func (t *PixmapTarget) Format() types.TextureFormat {
...
func NewTextureTarget(handle DeviceHandle, width, height int, format types.TextureFormat) (*TextureTarget, error) {
...
func (t *TextureTarget) Format() types.TextureFormat {
	return t.format
}
...
func NewSurfaceTarget(width, height int, format types.TextureFormat, view TextureView) *SurfaceTarget {
...
func (t *SurfaceTarget) Format() types.TextureFormat {
	return t.format
}
