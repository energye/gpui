...
func TestNewPixmapTarget(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if target.Format() != types.TextureFormatRGBA8Unorm {
...
func TestTextureTarget(t *testing.T) {
	...
	target, err := NewTextureTarget(NullDeviceHandle{}, 512, 512, types.TextureFormatRGBA8Unorm)
	if err != nil {
...
func TestSurfaceTarget(t *testing.T) {
	target := NewSurfaceTarget(800, 600, types.TextureFormatBGRA8Unorm, nil)
	...
	if target.Format() != types.TextureFormatBGRA8Unorm {
...
func TestRenderTargetInterface(t *testing.T) {
	...
	textureTarget, _ := NewTextureTarget(NullDeviceHandle{}, 100, 100, types.TextureFormatRGBA8Unorm)
	targets := []RenderTarget{
		NewPixmapTarget(100, 100),
		textureTarget,
		NewSurfaceTarget(100, 100, types.TextureFormatBGRA8Unorm, nil),
	}
