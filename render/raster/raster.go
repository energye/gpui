...
//
// If GPU acceleration is also needed, use import _ "github.com/energye/gpui/render/gpu"
// instead, which registers both the GPU accelerator and the coverage filler.
//
// Usage:
//
//	import _ "github.com/energye/gpui/render/raster" // enable CPU tile rasterization
package raster
