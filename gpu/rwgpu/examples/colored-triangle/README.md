...
Vertex: rwgpu.VertexState{
    Buffers: []rwgpu.VertexBufferLayout{{
        ...
        Attributes: []rwgpu.VertexAttribute{
            {Format: rwgpu.VertexFormatFloat32x2, Offset: 0, ShaderLocation: 0},
            {Format: rwgpu.VertexFormatFloat32x3, Offset: 8, ShaderLocation: 1},
        },
    }},
}
```
...
Включите debug mode:
```go
instance, _ := rwgpu.CreateInstance(&rwgpu.InstanceDescriptor{
