...
uniformBuffer := device.CreateBuffer(&rwgpu.BufferDescriptor{
    Usage:            rwgpu.BufferUsageUniform | rwgpu.BufferUsageCopyDst,
    Size:             uniformBufferSize,
    MappedAtCreation: rwgpu.False,
})
```
...
entries := []rwgpu.BindGroupEntry{
    rwgpu.BufferBindingEntry(0, uniformBuffer, 0, 64),
}
