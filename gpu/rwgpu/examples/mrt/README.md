...
```go
extraTexture := device.CreateTexture(&rwgpu.TextureDescriptor{
...
Fragment: &rwgpu.FragmentState{
    ...
    Targets: []rwgpu.ColorTargetState{
        {Format: rwgpu.TextureFormatBGRA8Unorm, WriteMask: rwgpu.ColorWriteMaskAll},
...
ColorAttachments: []rwgpu.RenderPassColorAttachment{
    {
        ...
        ClearValue: rwgpu.Color{R: 0.1, G: 0.2, B: 0.3, A: 1.0},
    },
    {
        View:    extraTextureView,     // @location(1)
        LoadOp:  rwgpu.LoadOpClear,
        StoreOp: rwgpu.StoreOpStore,
        ClearValue: rwgpu.Color{R: 0.0, G: 0.0, B: 0.0, A: 1.0},
    },
}
```
...
// Pipeline
Targets: []rwgpu.ColorTargetState{
    {Format: rwgpu.TextureFormatBGRA8Unorm, ...},  // Must match surface format
    {Format: rwgpu.TextureFormatRGBA8Unorm, ...},  // Must match extra texture format
}
```
