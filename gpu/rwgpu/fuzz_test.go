...
func FuzzToWGPUBufferBindingType(f *testing.F) {
	...
	f.Fuzz(func(t *testing.T, v uint32) {
		result := toWGPUBufferBindingType(types.BufferBindingType(v))
		if v == 0 && result != 0 {
...
func FuzzToWGPUSamplerBindingType(f *testing.F) {
	...
	f.Add(uint32(0xFFFFFFFF))
	f.Fuzz(func(t *testing.T, v uint32) {
		result := toWGPUSamplerBindingType(types.SamplerBindingType(v))
		if v == 0 && result != 0 {
			t.Errorf("zero input must map to zero, got %d", result)
		}
	})
...
func FuzzToWGPUTextureSampleType(f *testing.F) {
	...
	f.Add(uint32(0xFFFFFFFF))
	f.Fuzz(func(t *testing.T, v uint32) {
		result := toWGPUTextureSampleType(types.TextureSampleType(v))
		if v == 0 && result != 0 {
			t.Errorf("zero input must map to zero, got %d", result)
		}
	})
...
func FuzzToWGPUStorageTextureAccess(f *testing.F) {
	...
	f.Add(uint32(0xFFFFFFFF))
	f.Fuzz(func(t *testing.T, v uint32) {
		result := toWGPUStorageTextureAccess(types.StorageTextureAccess(v))
		if v == 0 && result != 0 {
			t.Errorf("zero input must map to zero, got %d", result)
		}
	})
...
func FuzzToWGPUVertexStepMode(f *testing.F) {
	...
	f.Add(uint32(0xFFFFFFFF))
	f.Fuzz(func(t *testing.T, v uint32) {
		_ = toWGPUVertexStepMode(types.VertexStepMode(v))
	})
}
...
func FuzzToWGPUVertexFormat(f *testing.F) {
	...
	f.Add(uint32(0xFFFFFFFF))
	f.Fuzz(func(t *testing.T, v uint32) {
		_ = toWGPUVertexFormat(types.VertexFormat(v))
	})
}
