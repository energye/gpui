...
type SamplerDescriptor struct {
	...
	MipmapFilter types.MipmapFilterMode
	LodMinClamp  float32
	LodMaxClamp  float32
...
type samplerDescriptorWire struct {
	...
	AddressModeU  types.AddressMode      // 4 bytes
	AddressModeV  types.AddressMode      // 4 bytes
	AddressModeW  types.AddressMode      // 4 bytes
	MagFilter     types.FilterMode       // 4 bytes
	MinFilter     types.FilterMode       // 4 bytes
	MipmapFilter  types.MipmapFilterMode // 4 bytes
	LodMinClamp   float32                // 4 bytes
	LodMaxClamp   float32                // 4 bytes
	Compare       types.CompareFunction  // 4 bytes
