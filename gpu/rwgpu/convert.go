...
func toWGPUBufferBindingType(t types.BufferBindingType) uint32 {
	if t == 0 {
...
func toWGPUSamplerBindingType(t types.SamplerBindingType) uint32 {
	if t == 0 {
		return 0 // gputypes Undefined=0 maps to wgpu BindingNotUsed=0
	}
	return uint32(t) + 1
...
func toWGPUTextureSampleType(t types.TextureSampleType) uint32 {
	if t == 0 {
		return 0 // gputypes Undefined=0 maps to wgpu BindingNotUsed=0
	}
	return uint32(t) + 1
...
func toWGPUStorageTextureAccess(t types.StorageTextureAccess) uint32 {
	if t == 0 {
		return 0 // gputypes Undefined=0 maps to wgpu BindingNotUsed=0
	}
	return uint32(t) + 1
...
func toWGPUVertexFormat(f types.VertexFormat) uint32 {
	switch f {
	case types.VertexFormatUndefined:
		return 0
