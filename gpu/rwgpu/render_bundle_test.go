...
func TestCreateRenderBundleEncoder(t *testing.T) {
	...
	colorFormats := []types.TextureFormat{types.TextureFormatBGRA8Unorm}
	encoder := device.CreateRenderBundleEncoderSimple(colorFormats, types.TextureFormatUndefined, 1)
	if encoder == nil {
...
`
	...
	colorFormats := []types.TextureFormat{types.TextureFormatBGRA8Unorm}
	bundleEncoder := device.CreateRenderBundleEncoderSimple(colorFormats, types.TextureFormatUndefined, 1)
