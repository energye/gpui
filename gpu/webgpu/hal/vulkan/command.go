...
func convertBufferImageCopyRegions(regions []hal.BufferTextureCopy, format types.TextureFormat) []vk.BufferImageCopy {
...
func offscreenFinalLayout(view *TextureView) vk.ImageLayout {
	if view.texture != nil && view.texture.usage&types.TextureUsageTextureBinding != 0 {
