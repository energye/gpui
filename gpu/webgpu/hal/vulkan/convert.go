...
func vkFormatToTextureFormat(format vk.Format) types.TextureFormat {
...
var vkFormatToTextureMap = map[vk.Format]types.TextureFormat{
	// BGRA formats (common surface formats)
	vk.FormatB8g8r8a8Unorm: types.TextureFormatBGRA8Unorm,
	vk.FormatB8g8r8a8Srgb:  types.TextureFormatBGRA8UnormSrgb,

	// RGBA formats
	vk.FormatR8g8b8a8Unorm: types.TextureFormatRGBA8Unorm,
	vk.FormatR8g8b8a8Srgb:  types.TextureFormatRGBA8UnormSrgb,
	vk.FormatR8g8b8a8Snorm: types.TextureFormatRGBA8Snorm,
	vk.FormatR8g8b8a8Uint:  types.TextureFormatRGBA8Uint,
	vk.FormatR8g8b8a8Sint:  types.TextureFormatRGBA8Sint,

	// 16-bit float formats
	vk.FormatR16g16b16a16Sfloat: types.TextureFormatRGBA16Float,

	// 32-bit float formats
	vk.FormatR32g32b32a32Sfloat: types.TextureFormatRGBA32Float,

	// Single channel formats
	vk.FormatR8Unorm:   types.TextureFormatR8Unorm,
	vk.FormatR16Sfloat: types.TextureFormatR16Float,
}
