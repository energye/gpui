...
import (
	...
	"github.com/energye/gpui/gpu/webgpu/hal/vulkan/vk"
)
...
func TestVkFormatToTextureFormat(t *testing.T) {
	tests := []struct {
		name   string
		format vk.Format
		expect types.TextureFormat
	}{
		{"BGRA8Unorm", vk.FormatB8g8r8a8Unorm, types.TextureFormatBGRA8Unorm},
		{"BGRA8Srgb", vk.FormatB8g8r8a8Srgb, types.TextureFormatBGRA8UnormSrgb},
		{"RGBA8Unorm", vk.FormatR8g8b8a8Unorm, types.TextureFormatRGBA8Unorm},
		{"RGBA8Srgb", vk.FormatR8g8b8a8Srgb, types.TextureFormatRGBA8UnormSrgb},
		{"RGBA8Snorm", vk.FormatR8g8b8a8Snorm, types.TextureFormatRGBA8Snorm},
		{"RGBA8Uint", vk.FormatR8g8b8a8Uint, types.TextureFormatRGBA8Uint},
		{"RGBA8Sint", vk.FormatR8g8b8a8Sint, types.TextureFormatRGBA8Sint},
		{"RGBA16Float", vk.FormatR16g16b16a16Sfloat, types.TextureFormatRGBA16Float},
		{"RGBA32Float", vk.FormatR32g32b32a32Sfloat, types.TextureFormatRGBA32Float},
		{"R8Unorm", vk.FormatR8Unorm, types.TextureFormatR8Unorm},
		{"R16Float", vk.FormatR16Sfloat, types.TextureFormatR16Float},
		{"Unknown returns Undefined", vk.Format(9999), types.TextureFormatUndefined},
	}
...
func TestLoadOpToVk(t *testing.T) {
	tests := []struct {
		...
		{"Clear", types.LoadOpClear, vk.AttachmentLoadOpClear},
		{"Load", types.LoadOpLoad, vk.AttachmentLoadOpLoad},
		{"Unknown defaults to DontCare", types.LoadOp(99), vk.AttachmentLoadOpDontCare},
	}
...
func TestStoreOpToVk(t *testing.T) {
	tests := []struct {
		...
		{"Store", types.StoreOpStore, vk.AttachmentStoreOpStore},
		{"Discard defaults to DontCare", types.StoreOpDiscard, vk.AttachmentStoreOpDontCare},
		{"Unknown defaults to DontCare", types.StoreOp(99), vk.AttachmentStoreOpDontCare},
	}
