...
func fillSurfaceColor(surf *Surface, r, g, b, a byte) {
	...
	bgra := surf.format == types.TextureFormatBGRA8Unorm ||
		surf.format == types.TextureFormatBGRA8UnormSrgb
...
func TestDamage_TextureClear_BGRAByteOrder(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			name:   "RGBA_green",
			format: types.TextureFormatRGBA8Unorm,
			color:  types.Color{R: 0, G: 1, B: 0, A: 1},
		...
		},
		{
			name:   "RGBA_blue",
			format: types.TextureFormatRGBA8Unorm,
			color:  types.Color{R: 0, G: 0, B: 1, A: 1},
		...
		},
		{
			name:   "BGRA_mixed",
			format: types.TextureFormatBGRA8Unorm,
			color:  types.Color{R: 1.0, G: 0.5, B: 0.25, A: 0.75},
...
func TestDamage_NeedsSwizzle(t *testing.T) {
	tests := []struct {
		name string
		src  types.TextureFormat
		dst  types.TextureFormat
		want bool
	}{
		{"RGBA_to_RGBA", types.TextureFormatRGBA8Unorm, types.TextureFormatRGBA8Unorm, false},
		{"BGRA_to_BGRA", types.TextureFormatBGRA8Unorm, types.TextureFormatBGRA8Unorm, false},
		{"RGBA_to_BGRA", types.TextureFormatRGBA8Unorm, types.TextureFormatBGRA8Unorm, true},
		{"BGRA_to_RGBA", types.TextureFormatBGRA8Unorm, types.TextureFormatRGBA8Unorm, true},
		{"BGRA_srgb_to_RGBA", types.TextureFormatBGRA8UnormSrgb, types.TextureFormatRGBA8Unorm, true},
		{"BGRA_to_BGRA_srgb", types.TextureFormatBGRA8Unorm, types.TextureFormatBGRA8UnormSrgb, false},
	}
...
func TestDamage_IsBGRA(t *testing.T) {
	tests := []struct {
		...
		{"BGRA8Unorm", types.TextureFormatBGRA8Unorm, true},
		{"BGRA8UnormSrgb", types.TextureFormatBGRA8UnormSrgb, true},
		{"R8Unorm", types.TextureFormatR8Unorm, false},
	}
...
func BenchmarkPresent_FullSurface(b *testing.B) {
	...
	openDev, _ := adapters[0].Adapter.Open(0, types.DefaultLimits())
...
func renderSolidColor(t *testing.T, dev *Device, surf *Surface, cr, cg, cb, ca float64) {
	...
	srcTex.(*Texture).Clear(types.Color{R: cr, G: cg, B: cb, A: ca})
		...
		ColorAttachments: []hal.RenderPassColorAttachment{
			{
				...
				ClearValue: types.Color{R: cr, G: cg, B: cb, A: ca},
			},
		},
	})
