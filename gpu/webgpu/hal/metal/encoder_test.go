...
func TestComputeBindSlots_PerTypeSequentialIndexing(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			entries: []types.BindGroupEntry{
				{Binding: 0, Resource: types.BufferBinding{Buffer: 0x100}},
				{Binding: 1, Resource: types.TextureViewBinding{TextureView: 0x200}},
				{Binding: 2, Resource: types.BufferBinding{Buffer: 0x300}},
				{Binding: 3, Resource: types.SamplerBinding{Sampler: 0x400}},
			},
		...
		},
		{
			...
			entries: []types.BindGroupEntry{
				{Binding: 0, Resource: types.BufferBinding{Buffer: 0x100}},
				{Binding: 1, Resource: types.BufferBinding{Buffer: 0x200}},
				{Binding: 2, Resource: types.BufferBinding{Buffer: 0x300}},
			},
		...
		},
		{
			...
			entries: []types.BindGroupEntry{
				{Binding: 0, Resource: types.TextureViewBinding{TextureView: 0x100}},
				{Binding: 1, Resource: types.SamplerBinding{Sampler: 0x200}},
				{Binding: 2, Resource: types.BufferBinding{Buffer: 0x300}},
			},
		...
		},
		{
			...
			entries: []types.BindGroupEntry{
				{Binding: 0, Resource: types.BufferBinding{Buffer: 0x100}},
				{Binding: 1, Resource: types.TextureViewBinding{TextureView: 0x200}},
				{Binding: 2, Resource: types.SamplerBinding{Sampler: 0x300}},
				{Binding: 3, Resource: types.TextureViewBinding{TextureView: 0x400}},
				{Binding: 4, Resource: types.SamplerBinding{Sampler: 0x500}},
				{Binding: 5, Resource: types.BufferBinding{Buffer: 0x600}},
			},
			wantBuffers:  []uintptr{0, 1},
		...
		},
		{
			...
			entries: []types.BindGroupEntry{
				{Binding: 0, Resource: types.BufferBinding{Buffer: 0x100}},
				{Binding: 5, Resource: types.TextureViewBinding{TextureView: 0x200}},
				{Binding: 10, Resource: types.BufferBinding{Buffer: 0x300}},
				{Binding: 15, Resource: types.SamplerBinding{Sampler: 0x400}},
				{Binding: 20, Resource: types.TextureViewBinding{TextureView: 0x500}},
			},
		...
		},
		{
			name: "single texture",
			entries: []types.BindGroupEntry{
				{Binding: 3, Resource: types.TextureViewBinding{TextureView: 0x100}},
			},
