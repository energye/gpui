...
func stencilOperationToMTL(op types.StencilOperation) MTLStencilOperation {
	switch op {
...
func vertexFormatToMTL(format types.VertexFormat) MTLVertexFormat {
	switch format {
...
func vertexStepModeToMTL(mode types.VertexStepMode) MTLVertexStepFunction {
	switch mode {
