...
func TestTextureFormatToGL(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			format:         types.TextureFormatDepth32FloatStencil8,
		...
		{
			name:           "BGRA8UnormSrgb",
			format:         types.TextureFormatBGRA8UnormSrgb,
			wantInternal:   gl.SRGB8_ALPHA8,
			wantDataFormat: gl.BGRA,
			wantDataType:   gl.UNSIGNED_BYTE,
		},
		...
		{
			name:           "RG16Float",
			format:         types.TextureFormatRG16Float,
		...
		{
			name:           "RG32Float",
			format:         types.TextureFormatRG32Float,
...
func TestVertexFormatToGL(t *testing.T) {
	tests := []struct {
		...
		// Float32 formats
		{"Float32", types.VertexFormatFloat32, 1, gl.FLOAT, false},
		{"Float32x2", types.VertexFormatFloat32x2, 2, gl.FLOAT, false},
		{"Float32x3", types.VertexFormatFloat32x3, 3, gl.FLOAT, false},
		{"Float32x4", types.VertexFormatFloat32x4, 4, gl.FLOAT, false},

		// 8-bit unsigned
		{"Uint8x2", types.VertexFormatUint8x2, 2, gl.UNSIGNED_BYTE, false},
		{"Uint8x4", types.VertexFormatUint8x4, 4, gl.UNSIGNED_BYTE, false},

		// 8-bit unsigned normalized
		{"Unorm8x2", types.VertexFormatUnorm8x2, 2, gl.UNSIGNED_BYTE, true},
		{"Unorm8x4", types.VertexFormatUnorm8x4, 4, gl.UNSIGNED_BYTE, true},

		// 8-bit signed
		{"Sint8x2", types.VertexFormatSint8x2, 2, gl.BYTE, false},
		{"Sint8x4", types.VertexFormatSint8x4, 4, gl.BYTE, false},

		// 8-bit signed normalized
		{"Snorm8x2", types.VertexFormatSnorm8x2, 2, gl.BYTE, true},
		{"Snorm8x4", types.VertexFormatSnorm8x4, 4, gl.BYTE, true},

		// 16-bit unsigned
		{"Uint16x2", types.VertexFormatUint16x2, 2, gl.UNSIGNED_SHORT, false},
		{"Uint16x4", types.VertexFormatUint16x4, 4, gl.UNSIGNED_SHORT, false},

		// 16-bit unsigned normalized
		{"Unorm16x2", types.VertexFormatUnorm16x2, 2, gl.UNSIGNED_SHORT, true},
		{"Unorm16x4", types.VertexFormatUnorm16x4, 4, gl.UNSIGNED_SHORT, true},

		// 16-bit signed
		{"Sint16x2", types.VertexFormatSint16x2, 2, gl.SHORT, false},
		{"Sint16x4", types.VertexFormatSint16x4, 4, gl.SHORT, false},

		// 16-bit signed normalized
		{"Snorm16x2", types.VertexFormatSnorm16x2, 2, gl.SHORT, true},
		{"Snorm16x4", types.VertexFormatSnorm16x4, 4, gl.SHORT, true},

		// 32-bit unsigned int
		{"Uint32", types.VertexFormatUint32, 1, gl.UNSIGNED_INT, false},
		{"Uint32x2", types.VertexFormatUint32x2, 2, gl.UNSIGNED_INT, false},
		{"Uint32x3", types.VertexFormatUint32x3, 3, gl.UNSIGNED_INT, false},
		{"Uint32x4", types.VertexFormatUint32x4, 4, gl.UNSIGNED_INT, false},

		// 32-bit signed int
		{"Sint32", types.VertexFormatSint32, 1, gl.INT, false},
		{"Sint32x2", types.VertexFormatSint32x2, 2, gl.INT, false},
		{"Sint32x3", types.VertexFormatSint32x3, 3, gl.INT, false},
		{"Sint32x4", types.VertexFormatSint32x4, 4, gl.INT, false},

		// Unknown defaults to Float32x4
		{"Unknown", types.VertexFormat(255), 4, gl.FLOAT, false},
	}
