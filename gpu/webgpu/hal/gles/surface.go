...
func allocateSwapchainFBO(glCtx *gl.Context, format types.TextureFormat, width, height uint32) (fbo, colorRbo uint32, err error) {
	if glCtx == nil {
...
func (s *Surface) reconfigureSwapchainFBOWith(glCtx *gl.Context, format types.TextureFormat, width, height uint32) error {
