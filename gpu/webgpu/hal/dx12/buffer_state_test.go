...
func TestComputePassSetBindGroupTracksBuffers(t *testing.T) {
	buf1 := &Buffer{usage: types.BufferUsageStorage, currentState: d3d12.D3D12_RESOURCE_STATE_COMMON}
	buf2 := &Buffer{usage: types.BufferUsageStorage, currentState: d3d12.D3D12_RESOURCE_STATE_COMMON}
