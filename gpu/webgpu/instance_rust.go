...
func convertRustLimits(rl rwgpu.Limits) types.Limits {
	return types.Limits{
...
func convertRustFeatures(names []rwgpu.FeatureName) types.Features {
...
var rustFeatureMap = map[rwgpu.FeatureName]types.Feature{
...
func convertRustBackendType(bt rwgpu.BackendType) types.Backend {
	switch bt {
...
func convertRustAdapterType(at rwgpu.AdapterType) types.DeviceType {
	switch at {
