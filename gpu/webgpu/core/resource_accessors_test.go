...
func TestTexture_Accessors(t *testing.T) {
	...
	size := types.Extent3D{Width: 256, Height: 128, DepthOrArrayLayers: 1}
	tex := NewTexture(
		mockTexture{}, device,
		types.TextureFormatRGBA8Unorm,
		types.TextureDimension2D,
		types.TextureUsageRenderAttachment|types.TextureUsageTextureBinding,
	...
	if tex.Usage() != types.TextureUsageRenderAttachment|types.TextureUsageTextureBinding {
...
func TestTexture_Destroy(t *testing.T) {
	...
	tex := NewTexture(
		mockTexture{}, device,
		types.TextureFormatRGBA8Unorm, types.TextureDimension2D,
		types.TextureUsageRenderAttachment,
		types.Extent3D{Width: 64, Height: 64, DepthOrArrayLayers: 1},
		1, 1, "DestroyTest",
	)
