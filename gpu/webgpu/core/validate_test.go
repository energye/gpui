...
func TestValidateTextureDescriptor_Valid(t *testing.T) {
	err := ValidateTextureDescriptor(validTextureDesc(), types.DefaultLimits())
	if err != nil {
...
func TestValidateTextureDescriptor_InvalidDimension(t *testing.T) {
	...
	desc.Dimension = types.TextureDimensionUndefined

	err := ValidateTextureDescriptor(desc, types.DefaultLimits())
	if err == nil {
...
func TestValidateTextureDescriptor_InvalidFormat(t *testing.T) {
	desc := validTextureDesc()
	desc.Format = types.TextureFormatUndefined
...
func TestValidateTextureDescriptor_MaxDimension1D(t *testing.T) {
	...
	desc := validTextureDesc()
	desc.Dimension = types.TextureDimension1D
...
func TestValidateTextureDescriptor_MaxDimension3D(t *testing.T) {
	limits := types.DefaultLimits()
	desc := validTextureDesc()
	desc.Dimension = types.TextureDimension3D
...
func TestValidateTextureDescriptor_EmptyUsage(t *testing.T) {
	desc := validTextureDesc()
	desc.Usage = types.TextureUsageNone
...
func TestValidateTextureDescriptor_InvalidUsage(t *testing.T) {
	desc := validTextureDesc()
	desc.Usage = types.TextureUsage(1 << 30) // Unknown flag
...
func TestValidateTextureDescriptor_MultisampleStorageBinding(t *testing.T) {
	...
	desc.MipLevelCount = 1
	desc.Size = hal.Extent3D{Width: 64, Height: 64, DepthOrArrayLayers: 1}
	desc.Usage = types.TextureUsageTextureBinding | types.TextureUsageStorageBinding
...
func TestValidateTextureDescriptor_ValidMultisample(t *testing.T) {
	...
	desc.MipLevelCount = 1
	desc.Size = hal.Extent3D{Width: 64, Height: 64, DepthOrArrayLayers: 1}
	desc.Usage = types.TextureUsageRenderAttachment
...
func TestValidateRenderPipelineDescriptor_Valid(t *testing.T) {
	desc := &hal.RenderPipelineDescriptor{
		...
		Multisample: types.MultisampleState{Count: 1},
	}
	err := ValidateRenderPipelineDescriptor(desc, types.DefaultLimits())
	if err != nil {
		t.Fatalf("expected nil error, got: %v", err)
	}
}
...
func TestValidateRenderPipelineDescriptor_TooManyColorTargets(t *testing.T) {
	limits := types.DefaultLimits()
	targets := make([]types.ColorTargetState, limits.MaxColorAttachments+1)
	desc := &hal.RenderPipelineDescriptor{
		Label: "test",
		Vertex: hal.VertexState{
			Module:     mockShaderModule{},
...
func TestValidateRenderPipelineDescriptor_InvalidSampleCount(t *testing.T) {
	desc := &hal.RenderPipelineDescriptor{
		...
		Multisample: types.MultisampleState{Count: 3},
	}
	err := ValidateRenderPipelineDescriptor(desc, types.DefaultLimits())
	if err == nil {
...
func TestValidateBindGroupLayoutDescriptor_Valid(t *testing.T) {
	...
	err := ValidateBindGroupLayoutDescriptor(desc, types.DefaultLimits())
	if err != nil {
		t.Fatalf("expected nil error, got: %v", err)
	}
}
...
func TestValidateBindGroupLayoutDescriptor_TooManyBindings(t *testing.T) {
	limits := types.DefaultLimits()
	entries := make([]types.BindGroupLayoutEntry, limits.MaxBindingsPerBindGroup+1)
	for i := range entries {
...
func TestValidateBindGroupDescriptor_Valid(t *testing.T) {
	layoutEntries := []types.BindGroupLayoutEntry{
		{Binding: 0},
		{Binding: 1},
		{Binding: 2},
	}
	...
	err := ValidateBindGroupDescriptor(desc, layoutEntries, nil, types.Limits{})
	if err != nil {
		t.Fatalf("expected nil error, got: %v", err)
	}
}
...
func TestValidateBindGroupDescriptor_MissingLayout(t *testing.T) {
	...
	err := ValidateBindGroupDescriptor(desc, nil, nil, types.Limits{})
	if err == nil {
...
func TestValidatePipelineLayoutDescriptor_Empty(t *testing.T) {
	...
	err := ValidatePipelineLayoutDescriptor(desc, types.DefaultLimits())
	if err != nil {
...
func TestValidateRenderPipelineDescriptor_ColorTargetDepthFormat(t *testing.T) {
	depthFormats := []types.TextureFormat{
		...
		t.Run(f.String(), func(t *testing.T) {
			desc := &hal.RenderPipelineDescriptor{
				...
				Fragment: &hal.FragmentState{
					Module:     mockShaderModule{},
					EntryPoint: "fs_main",
					Targets:    []types.ColorTargetState{{Format: f}},
				},
				Multisample: types.MultisampleState{Count: 1},
			}
			err := ValidateRenderPipelineDescriptor(desc, types.DefaultLimits())
...
func TestValidateRenderPipelineDescriptor_ColorTargetDepthFormat_SecondTarget(t *testing.T) {
	desc := &hal.RenderPipelineDescriptor{
		...
		Fragment: &hal.FragmentState{
			...
			EntryPoint: "fs_main",
			Targets: []types.ColorTargetState{
				{Format: types.TextureFormatRGBA8Unorm},   // valid color format
				{Format: types.TextureFormatDepth32Float}, // invalid: depth format
			},
		},
		Multisample: types.MultisampleState{Count: 1},
	}
...
func TestMaxMips(t *testing.T) {
	tests := []struct {
		...
		{"1x1 2D", types.TextureDimension2D, 1, 1, 1, 1},
		{"2x2 2D", types.TextureDimension2D, 2, 2, 1, 2},
		{"256x256 2D", types.TextureDimension2D, 256, 256, 1, 9},
		{"1024x1 1D", types.TextureDimension1D, 1024, 1, 1, 11},
		{"16x16x16 3D", types.TextureDimension3D, 16, 16, 16, 5},
		{"256x128 2D", types.TextureDimension2D, 256, 128, 1, 9},
		{"0 dimension", types.TextureDimension2D, 0, 0, 0, 0},
	}
...
func TestValidateBindGroupDescriptor_BufferUsageMismatch_UniformAsStorage(t *testing.T) {
	...
	bufferInfos[0].Usage = types.BufferUsageStorage
...
func TestValidateBindGroupDescriptor_BufferUsageMismatch_StorageAsUniform(t *testing.T) {
	...
	layoutEntries[0].Buffer.Type = types.BufferBindingTypeStorage
	// Buffer only has uniform usage, not storage.
	bufferInfos[0].Usage = types.BufferUsageUniform
...
func TestValidateBindGroupDescriptor_StorageBufferSizeMultipleOf4_ReadOnly(t *testing.T) {
	desc, layoutEntries, bufferInfos, limits := validBindGroupBufferSetup()
	layoutEntries[0].Buffer.Type = types.BufferBindingTypeReadOnlyStorage
	bufferInfos[0].Usage = types.BufferUsageStorage
...
func TestValidateRenderPipelineDescriptor_Stencil8_DepthCompareNotAlways(t *testing.T) {
	...
	desc := &hal.RenderPipelineDescriptor{
		...
		DepthStencil: &hal.DepthStencilState{
			Format:       types.TextureFormatStencil8,
			DepthCompare: types.CompareFunctionLess, // not Always -> depth enabled
		},
		Multisample: types.MultisampleState{Count: 1},
	}
	err := ValidateRenderPipelineDescriptor(desc, types.DefaultLimits())
...
func TestValidateRenderPipelineDescriptor_Depth32Float_StencilOpsEnabled(t *testing.T) {
	...
	desc := &hal.RenderPipelineDescriptor{
		...
		DepthStencil: &hal.DepthStencilState{
			...
			DepthCompare: types.CompareFunctionAlways,
			StencilFront: hal.StencilFaceState{
				Compare: types.CompareFunctionLess, // non-Always compare -> stencil enabled
				FailOp:  hal.StencilOperationKeep,
				PassOp:  hal.StencilOperationKeep,
			},
			StencilBack: hal.StencilFaceState{
...
func TestValidateRenderPipelineDescriptor_DepthOnly_NoStencilOps(t *testing.T) {
	...
	depthOnlyFormats := []types.TextureFormat{
		types.TextureFormatDepth16Unorm,
		types.TextureFormatDepth24Plus,
		types.TextureFormatDepth32Float,
	}
...
func TestValidateRenderPipelineDescriptor_Stencil8_NoDepthOps(t *testing.T) {
	...
	desc := &hal.RenderPipelineDescriptor{
		...
		DepthStencil: &hal.DepthStencilState{
			...
			DepthCompare:      types.CompareFunctionAlways, // depth disabled
			StencilFront: hal.StencilFaceState{
				Compare: types.CompareFunctionNotEqual,
				FailOp:  hal.StencilOperationKeep,
				PassOp:  hal.StencilOperationReplace,
