...
func (a *stubHALAdapter) Open(_ types.Features, _ types.Limits) (hal.OpenDevice, error) {
	return hal.OpenDevice{}, nil
}
func (a *stubHALAdapter) TextureFormatCapabilities(_ types.TextureFormat) hal.TextureFormatCapabilities {
	...
	return []hal.ExposedAdapter{
		{
			...
			Capabilities: hal.Capabilities{Limits: types.DefaultLimits()},
		},
	}
}
...
func TestRequestAdapterWithSurface_SelectsGLESAdapter(t *testing.T) {
	...
	if adapter.Info.Backend != types.BackendGL {
