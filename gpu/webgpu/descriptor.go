...
func (e *BindGroupEntry) toHAL() types.BindGroupEntry {
	entry := types.BindGroupEntry{
		Binding: e.Binding,
	}
	...
	case e.Buffer != nil:
		...
		if halBuf != nil {
			entry.Resource = types.BufferBinding{
