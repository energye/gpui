...
func TestSubmitWithDestroyedBuffer(t *testing.T) {
	...
	srcBuf, err := device.CreateBuffer(&webgpu.BufferDescriptor{
	...
	if !errors.Is(err, webgpu.ErrSubmitBufferDestroyed) {
...
func TestSubmitWithMappedBuffer(t *testing.T) {
	...
	mappedBuf, err := device.CreateBuffer(&webgpu.BufferDescriptor{
	...
	if !errors.Is(err, webgpu.ErrSubmitBufferMapped) {
...
func TestSubmitWithDestroyedTexture(t *testing.T) {
	...
	tex, err := device.CreateTexture(&webgpu.TextureDescriptor{
		...
		Usage:         webgpu.TextureUsageCopySrc | webgpu.TextureUsageCopyDst,
	})
	if err != nil {
	...
	enc.CopyTextureToBuffer(tex, dstBuf, []webgpu.BufferTextureCopy{
		{
	...
	if !errors.Is(err, webgpu.ErrSubmitTextureDestroyed) {
...
func TestSubmitDoubleSubmit(t *testing.T) {
	...
	if !errors.Is(err, webgpu.ErrSubmitCommandBufferInvalid) {
...
func TestSubmitWithDestroyedBindGroup(t *testing.T) {
	...
	if !errors.Is(err, webgpu.ErrSubmitBindGroupDestroyed) {
