...
type Surface struct {
	...
	currentBackend types.Backend // backend type of the current HAL surface
...
func (i *Instance) CreateSurface(displayHandle, windowHandle uintptr) (*Surface, error) {
	...
	var initialBackend types.Backend
...
func (s *Surface) ensureHALSurface(backend types.Backend) error {
