...
var Controls = []Control{
	...
	{Name: "divider", Doc: "docs/antd/divider.md", Wave: "W1", Status: NotStarted, P1: "见 docs/antd/divider.md §6.8 P1"},
	{Name: "flex", Doc: "docs/antd/flex.md", Wave: "W1", Status: NotStarted, P1: "见 docs/antd/flex.md §6.8 P1"},
	{Name: "float-button", Doc: "docs/antd/float-button.md", Wave: "W1", Status: NotStarted, P1: "见 docs/antd/float-button.md §6.8 P1"},
	{Name: "grid", Doc: "docs/antd/grid.md", Wave: "W1", Status: NotStarted, P1: "见 docs/antd/grid.md §6.8 P1"},
	{Name: "layout", Doc: "docs/antd/layout.md", Wave: "W1", Status: NotStarted, P1: "见 docs/antd/layout.md §6.8 P1"},
	{Name: "masonry", Doc: "docs/antd/masonry.md", Wave: "W1", Status: NotStarted, P1: "见 docs/antd/masonry.md §6.8 P1"},
	{Name: "progress", Doc: "docs/antd/progress.md", Wave: "W1", Status: NotStarted, P1: "见 docs/antd/progress.md §6.8 P1"},
	{Name: "skeleton", Doc: "docs/antd/skeleton.md", Wave: "W1", Status: NotStarted, P1: "见 docs/antd/skeleton.md §6.8 P1"},
	{Name: "space", Doc: "docs/antd/space.md", Wave: "W1", Status: NotStarted, P1: "见 docs/antd/space.md §6.8 P1"},
	{Name: "spin", Doc: "docs/antd/spin.md", Wave: "W1", Status: NotStarted, P1: "见 docs/antd/spin.md §6.8 P1"},
	{Name: "splitter", Doc: "docs/antd/splitter.md", Wave: "W1", Status: NotStarted, P1: "见 docs/antd/splitter.md §6.8 P1"},
	{Name: "statistic", Doc: "docs/antd/statistic.md", Wave: "W1", Status: NotStarted, P1: "见 docs/antd/statistic.md §6.8 P1"},
	{Name: "tag", Doc: "docs/antd/tag.md", Wave: "W1", Status: NotStarted, P1: "见 docs/antd/tag.md §6.8 P1"},
	{Name: "timeline", Doc: "docs/antd/timeline.md", Wave: "W1", Status: NotStarted, P1: "见 docs/antd/timeline.md §6.8 P1"},
	{Name: "typography", Doc: "docs/antd/typography.md", Wave: "W1", Status: NotStarted, P1: "见 docs/antd/typography.md §6.8 P1"},
	{Name: "watermark", Doc: "docs/antd/watermark.md", Wave: "W1", Status: NotStarted, P1: "见 docs/antd/watermark.md §6.8 P1"},
	...
	{Name: "tooltip", Doc: "docs/antd/tooltip.md", Wave: "W2", Status: NotStarted, P1: "见 docs/antd/tooltip.md §6.8 P1"},
	{Name: "popover", Doc: "docs/antd/popover.md", Wave: "W2", Status: NotStarted, P1: "见 docs/antd/popover.md §6.8 P1"},
