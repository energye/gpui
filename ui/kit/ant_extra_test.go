...
func TestCollapseTimelineSliderResult(t *testing.T) {
	...
	ds := kit.NewDescriptions(
		kit.DescriptionsItem{Label: "Name", Children: "Ada"},
		kit.DescriptionsItem{Label: "Role", Children: "Admin"},
	)
...
func TestCatalogRestAPIs(t *testing.T) {
	...
	wm := kit.NewWatermark(kit.NewText("content").Node())
	wm.SetContent("CONFIDENTIAL")
