...
func main() {
	...
	if err := render.RegisterAccelerator(&render.SDFAccelerator{}); err != nil {
	...
	// Dark background
	dc.ClearWithColor(render.RGB(0.086, 0.129, 0.243))
	...
	if err := dc.SavePNG("tmp/render_sdf.png"); err != nil {
	...
	fmt.Println("Saved: tmp/render_sdf.png")
	fmt.Println()
