...
//
// Output: tmp/render_scene_gpu.png (512x512)
package main
...
import (
	...
	_ "github.com/energye/gpui/render/gpu" // GPU acceleration for scene rendering
...
func main() {
	...
	if err := target.SavePNG("tmp/render_scene_gpu.png"); err != nil {
		log.Fatalf("SavePNG: %v", err)
	}
	fmt.Println("Saved: tmp/render_scene_gpu.png")
}
