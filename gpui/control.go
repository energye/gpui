...
import (
	...
	"github.com/energye/gpui/gpui/gl"
...
type TGPUControl struct {
	...
	ggCtx    *gg.Context       // gg rendering context
	texture  uint32
	vao      uint32
	vbo      uint32
	program  uint32
...
func (c *TGPUControl) SetOnRender(fn func(*gg.Context)) { c.onRender = fn }
