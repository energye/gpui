...
| 10 | [07_text](./07_text.md) | C/A · ellipsis·Paragraph✅ | BiDi · 全量富文本 |
...
|------|------|------------|
| P0 | 几何/指标/Geometry | ✅ |
| P1 | wrap/path/layer/**TransformLayer**/Image·Text·ellipsis·**最小Paragraph** | 主路径 ✅；全量富文本/BiDi 后置 |
...
|--------|------|------|
| P1 | ~~exhost 真 VSync~~ ✅ | — |
| P1 | ~~ParagraphBuilder 最小多 span~~ ✅ | 全量富文本/BiDi 仍开 |
