...
**本轮（P1 推进）**：T.03 non-uniform stroke、X.06 MultiFace GPU、X.11 atlas、X.03/X.04/Q.03/L.06、B.02、D.04–D.06、Tier A/B/C 已绿。已收：至 Tier F（Cascader/VirtualList）、H.03 EvenOdd、L.06 PushMaskLayer、P.04 hairline。已收：F.03、L.06 MaskAware + convex/SDF cover-inline R8、Tier G/H/I。仍 open：F.03 GPU-RT 加深、M4、极端密度。

下一步：F.03 GPU multi-RT 加深、M4 与极端 Ant 密度 / damage。
