...
> 版本：2.2 | 日期：2026-07-23  
> 状态：**底层已交付，可供 kit 主开发**（P0 + F1–F8 + 三项收口）  
> **Kit 开发必读：** [`UI_KIT_DEV_GUIDE.md`](./UI_KIT_DEV_GUIDE.md) · **Ant 对齐：** [`UI_KIT_ANT_V5_SPEC.md`](./UI_KIT_ANT_V5_SPEC.md)  
...
| 文档 | 关系 |
|------|------|
| [`UI_KIT_DEV_GUIDE.md`](./UI_KIT_DEV_GUIDE.md) | **kit 开发入口**（契约清单 + API 速查） |
| [`UI_KIT_ANT_V5_SPEC.md`](./UI_KIT_ANT_V5_SPEC.md) | Ant v5 对齐目标、Wave 分期、L1–L4 验收 |
| [`LAYOUT_FOUNDATION.md`](./LAYOUT_FOUNDATION.md) | 布局/命中铁律 |
| [`UI_FRAMEWORK_MAP.md`](./UI_FRAMEWORK_MAP.md) | 架构总图；本文件补管道完备度 |
| [`UI_APP_SHELL_PLAN.md`](./UI_APP_SHELL_PLAN.md) | 按需帧 + OwnedPresenter；多窗后置 |
| [`UI_KIT_COVERAGE.md`](./UI_KIT_COVERAGE.md) | 覆盖率摘要；权威 `coverage.go` |
| [`S5_WIDGET_ENTRY.md`](./S5_WIDGET_ENTRY.md) | 控件层开工引擎条件 |
...
| 包 | 状态 | 备注 |
|----|------|------|
| P0.1–P0.5 | ✅ | 契约·浮层·滚动决策·编辑/剪贴板·Present |
| F1–F8 | ✅ | 拖选·Cursor·浮层回归·Present 锁·IME 位·Text 省略·滚动 chain·Theme |
| 三项收口 | ✅ | 修饰键·浮层自动锚点·Theme 广播 |
| **Kit 手册** | ✅ | [`UI_KIT_DEV_GUIDE.md`](./UI_KIT_DEV_GUIDE.md) |
| 后置 | ⏳ | Linux XIM · Win/mac 真 Host/GPU · 多窗 · 原生剪贴板 API |
