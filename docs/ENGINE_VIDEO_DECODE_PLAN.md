...
| V2 | H.265 / VP9 / AV1 新编码能解 | V2-1头已通（2026-09-17，见§12 V2行）：盒子认hvc1/hev1、hvcC解析、注册h265名、播报人话错不崩；V2-2首帧语法逐位对齐（2026-09-17，见§10 v0.87）：IDR零拒收/117CU/停9663比特全对对端；像素反变换与帧内预测、P/B、独立真窗仍缺 | 头通首帧语法通，像素与P/B仍缺，坑已啃掉大半 |
...
| V2 | VW7 片源广 | H.265（新包 + 注册，播放器零改） | 🟨 进行中 | V2-1头已通（2026-09-17）+ V2-2参数/切片头读全（见§10 v0.85/v0.86）+ 首帧语法逐位对齐（2026-09-17，见§10 v0.87）：IDR零拒收/4CTB/117CU/232TU/停9663-9672比特全对对端10218比特 + 门禁`video/h265/v22_syntax_test.go`2项绿；H.264像素门禁（`video/h264`整包+`video`根+`mp4`/`color`/`clock`）全绿；系数反变换+帧内预测出像素、P/B、独立真窗另开，不在本项 |
