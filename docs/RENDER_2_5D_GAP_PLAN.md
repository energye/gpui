...
| W6 | 4.3，5.2，5.5，6.1（1.2已前移W5） | 波内全可并行 | 真窗看得出盖对、动作顺、气氛对 | 已绿（2026-09-15：四能力行全已完成；单测见各行＋game_anim/game_particle/game_fx/game_light四窗自动判全PASS＋离屏金图0差；4.3窗线画跨后端像素比不硬比见该行；W6关） |
