...
| **1c** | [`ENGINE_UI_RENDER_BASE.md`](./ENGINE_UI_RENDER_BASE.md) | **Flutter 渲染基座能力总表 · 正向指标（与能力并行 §0.5）· Wave** |
...
go run ./examples/ui_render_base_geometry  # Geometry 轴（§2 FC-DRAW-* P0）
