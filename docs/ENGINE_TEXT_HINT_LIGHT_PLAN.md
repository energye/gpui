...
| M4b-5 | afindic light | 无字节码 Indic TTF light 化 | 未开始（相关差异现状见 M4b-6 备注：deva/beng/taml 复杂组合字形残余） |
