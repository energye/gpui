...
//
//	go get github.com/energye/gpui/gg-pdf
//	go get github.com/energye/gpui/gg-svg
//
...
import (
	...
	"github.com/energye/gpui/gg"
	"github.com/energye/gpui/gg/recording"
	_ "github.com/energye/gpui/gg/recording/backends/raster" // Built-in raster backend
	// _ "github.com/energye/gpui/gg-pdf" // Uncomment for PDF export
	// _ "github.com/energye/gpui/gg-svg" // Uncomment for SVG export
)
...
func main() {
	...
	if recording.IsRegistered("pdf") {
		...
		fmt.Println("PDF backend not available (import github.com/energye/gpui/gg-pdf)")
	}
	...
	if recording.IsRegistered("svg") {
		...
		fmt.Println("SVG backend not available (import github.com/energye/gpui/gg-svg)")
	}
}
