...
//
//	// PDF output (requires github.com/energye/gpui/gg-pdf)
//	import _ "github.com/energye/gpui/gg-pdf"
//
//	pdfBackend, _ := recording.NewBackend("pdf")
//	r.Playback(pdfBackend)
//	pdfBackend.(recording.FileBackend).SaveToFile("output.pdf")
//
//	// SVG output (requires github.com/energye/gpui/gg-svg)
//	import _ "github.com/energye/gpui/gg-svg"
//
...
//	    _ "github.com/energye/gpui/gg-pdf"  // Registers "pdf" backend
//	    _ "github.com/energye/gpui/gg-svg"  // Registers "svg" backend
//	)
//
// The built-in "raster" backend is always available via:
//
//	import _ "github.com/energye/gpui/gg/recording/backends/raster"
//
// # Resource Management
//
